...
const userProducts = [{
            title: "Fruitcake (2020)",
            description: `There's a fruitcake for everybody
            There's a fruitcake for everyone
            There are b-sides to every story
            If you decide to have some fun Take a bite
            It's alright.`,
            image: "users/user1/product-image/5.webp",
            video: "users/user1/product-video/video3.webm",
            price: 999.99
        }, {
            title: "Somewhere over the rainbow (2019)",
            description: `Somewhere over the rainbow
            Skies are blue
            And the dreams that you dare to dream
            Really do come true.`,
            image: "users/user1/product-image/4.webp",
            video: "users/user1/product-video/video3.webm",
            price: 999.99
        }, {
            title: "Bed of Roses",
